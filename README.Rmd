...
[![Codecov test coverage](https://codecov.io/gh/emmaw20/practice.regexcite/graph/badge.svg)](https://app.codecov.io/gh/emmaw20/practice.regexcite)
<!-- badges: end -->

The goal of practice.regexcite is to make regular expressions more exciting!
...
You can install the development version of practice.regexcite from [GitHub](https://github.com/) with:
